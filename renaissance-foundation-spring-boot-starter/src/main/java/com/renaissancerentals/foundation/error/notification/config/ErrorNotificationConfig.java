...
public class ErrorNotificationConfig {
    ...
    @Bean
    public ExceptionNotifier<ServerException> serverExceptionNotifier(
            ErrorNotificationConfigProperties properties,
            TemplateMessageFactory templateMessageFactory,
