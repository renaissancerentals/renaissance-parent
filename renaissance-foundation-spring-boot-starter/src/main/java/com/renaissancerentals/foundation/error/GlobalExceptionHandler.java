...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleServerException(ServerException ex) {
        ...
        return ResponseEntity.status(
                        Optional.ofNullable(ex.getErrorMessage().status()).orElse(HttpStatus.INTERNAL_SERVER_ERROR))
                .body(ErrorResponse.builder()
                        .errorMessage(ex.getErrorMessage().message())
                        .errorCode(ex.getErrorMessage().code())
                        .build());
    }
    ...
    public ResponseEntity<ErrorResponse> handleClientException(ClientException ex) {
        ...
        return ResponseEntity.status(
                        Optional.ofNullable(ex.getErrorMessage().status()).orElse(HttpStatus.BAD_REQUEST))
                .body(ErrorResponse.builder()
                        .errorMessage(ex.getErrorMessage().message())
                        .errorCode(ex.getErrorMessage().code())
                        .build());
    ...
    public ResponseEntity<ErrorResponse> handleBusinessException(BusinessException ex) {
        ...
        return ResponseEntity.status(
                        Optional.ofNullable(ex.getErrorMessage().status()).orElse(HttpStatus.UNPROCESSABLE_ENTITY))
                .body(ErrorResponse.builder()
                        .errorMessage(ex.getErrorMessage().message())
                        .errorCode(ex.getErrorMessage().code())
                        .build());
