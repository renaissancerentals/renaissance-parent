...
public class VideoAssetController {
    ...
    public ResponseEntity<PagedResult<VideoAsset>> getByFolder(@PathVariable("folderId") String folderId,
    ...
    public ResponseEntity<VideoAsset> getByFolderIdAndName(@PathVariable("folderId") String folderId,
