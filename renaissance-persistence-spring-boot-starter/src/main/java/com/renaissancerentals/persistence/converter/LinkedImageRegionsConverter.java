...
public class LinkedImageRegionsConverter {
    @WritingConverter
    public record LinkedImageWritingConverter(
            ObjectMapper objectMapper) implements Converter<LinkedImageRegions, PGobject> {
        @Override
    ...
    @ReadingConverter
    public record LinkedImageReadingConverter(
            ObjectMapper objectMapper) implements Converter<PGobject, LinkedImageRegions> {
