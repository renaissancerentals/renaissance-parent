...
public class FloorplanController {
    ...
    public ResponseEntity<?> get(@PathVariable("floorplanId") String floorplanId,
        ...
        switch (projection) {
            ...
            case DETAILS -> {
                return ResponseEntity.ok(floorplanRepository.getFloorplanDetails(floorplanId).orElseThrow(
    ...
    public ResponseEntity<List<SimilarFloorplan>> getSimilarFloorplans(@PathVariable("floorplanId") String floorplanId) {
        return ResponseEntity.ok(floorplanService.findSimilarFloorplans(floorplanId));
    }

    @GetMapping("/{floorplanId}/variations")
    public ResponseEntity<List<FloorplanVariation>> getFloorplanVariations(@PathVariable("floorplanId") String floorplanId) {
