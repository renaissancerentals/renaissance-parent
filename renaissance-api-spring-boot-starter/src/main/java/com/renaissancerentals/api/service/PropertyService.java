...
public class PropertyService {
    ...
    public PropertyContact getPropertyContact(String propertyId) {
        ...
        return propertyDao
                .findById(propertyId)
                .map(propertyMapper::toPropertyContact)
                .orElse(PropertyContact.builder()
                        .propertyName("Renaissance Rentals")
                        .email(propertyConfigProperties.defaultPropertyEmail())
                        .phone(propertyConfigProperties.defaultPropertyPhone())
                        .build());
    }
    ...
    public TeamMember getPropertyManager(String propertyId) {
        return propertyRepository
                ...
                .orElse(TeamMember.builder()
                        .email(propertyConfigProperties.defaultPropertyEmail())
                        .name(propertyConfigProperties.defaultPropertyManager())
                        .build());
    }

    public String getPropertyUrl(String propertyId) {
        return propertyConfigProperties
                .propertyUrls()
                .getOrDefault(propertyId, propertyConfigProperties.defaultPropertyUrl());
    }
    ...
    public List<FloorplanListing> getFloorplanListingsForProperty(String propertyId) {
        return propertyRepository
                ...
                .map(PropertyListing::getFloorplans)
                .orElse(List.of());
    }

    public List<Faq> getPropertyFaqs(String propertyId) {
        return propertyFaqDao.findAllByPropertyId(propertyId).stream()
                .map(faqMapper::toFaq)
                .toList();
    }
