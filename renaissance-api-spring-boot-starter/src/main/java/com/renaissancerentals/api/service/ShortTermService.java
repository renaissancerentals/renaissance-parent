...
public class ShortTermService {
    ...
    public List<ShortTermFloorplan> getShortTermFloorplansForProperty(String propertyId) {
        ...
        var propertySummary = propertySummaryFuture
                .join()
                .orElseThrow(() -> new NotFoundException(String.format("Property with id %s not found", propertyId)));
        CompletableFuture.allOf(propertySummaryFuture, floorplanDetailsFuture, shortTermEntityFuture)
                .join();
        ...
        return shortTermEntityFuture.join().stream()
                .map(shortTermEntity -> {
                    var floorplanDetails = floorplanDetailsMap.get(shortTermEntity.getFloorplanId());
                    if (floorplanDetails == null) return null;
                    ...
                    return ShortTermFloorplan.builder()
                            ...
                            .squareFoot(shortTermEntity.getSquareFoot())
                            .build();
                })
