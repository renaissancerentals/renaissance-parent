...
public record PropertyConfigProperties(
        String defaultPropertyEmail,
        String defaultPropertyPhone,
        String defaultPropertyManager,
        String defaultPropertyUrl,
        Map<String, String> propertyUrls) {
